        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    <label for="id" class="col-sm-2 control-label">Codigo Retiro</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="id" placeholder="{{$retiro->ret_codigo}}" readonly>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="genero" placeholder="{{$retiro->ret_fecha}}" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label for="fecha" class="col-sm-2 control-label">Descripcion</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="fecha" placeholder="{{$retiro->ret_descripcion}}" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label for="sinopsis" class="col-sm-2 control-label">Valor</label>
                    <div class="col-sm-10">
                        <input class="form-control" id="sinopsis" style="resize: none; text-align:justify;" placeholder="{{$retiro->ret_valor}}" readonly></textarea>
                    </div>
                </div>
            </div>
        </div>
